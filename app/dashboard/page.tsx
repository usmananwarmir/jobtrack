...
import { CalendarClock, ChartColumnIncreasing, FileText, Plus } from "lucide-react";
        ...
        <div className="glass mt-6 rounded-3xl p-5">
          ...
          {applications.length === 0 ? (
            <p className="mt-6 text-sm text-muted">
              No applications yet.{" "}
              <Link href="/applications/new" className="text-cyan-500">
            ...
            <div className="mt-4 overflow-x-auto">
              <table className="w-full min-w-[760px] text-left text-sm">
                ...
                <tbody>
                  {applications.slice(0, 8).map((job) => (
              ...
              {applications.length > 8 ? (
                <Link href="/applications" className="mt-4 inline-block text-sm text-cyan-500">
